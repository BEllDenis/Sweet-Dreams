...
<section class="banner">
  ...
  <div class="banner-image flex-col" >
    ...
    <div class="banner-container wrapper flex-col">
      ...
      <a class="button filled banner-button flex-row" @click="ToCatalog()">
...
<section class="new_products wrapper flex-col">
  ...
  <a class="button filled flex-row" @click="ToCatalog()">  
    <i class="icon-catalog icon"></i>
...
<section class="users_comments wrapper flex-col">
  <h2>Отзывы</h2>

  <div class="users_comments_cards">

    <div class="user_comment_card flex-col tilt-element" v-for="(Comment, index) in UserComments">
      <div class="user flex-row">
        <i class="user_comment-icon icon-man "></i>
        <p class="username">{{ Comment.Name }}<br>{{ Comment.Surname }}</p>
      </div>
      
      <p class="user_comment">{{ Comment.ReviewText }}</p>          
    </div>
